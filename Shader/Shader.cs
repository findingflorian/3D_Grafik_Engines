...
class Shader
{
    ...
    private void CheckShaderCompilation(int shader, string shaderType)
    {
        ...
        if (code != (int)All.True)
        {
            ...
            Console.WriteLine($"Shader Compilation Error ({shaderType}): {infoLog}");
        }
    }

    public Shader(string vertPath, string fragPath)
    {
        // Example of checking vertex shader compilation status
      
      

        // Add a similar block for fragment shader
